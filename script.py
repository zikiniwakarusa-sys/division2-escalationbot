...
LOOT_JA = {
    ...
    "Cavalier": "キャバリエ",
    "Concentrated Company": "コンセイトレイテッドカンパニー",
    "Core Strength": "コア強度",
...
def post(webhook, sections):
    ...
    embed = {
        ...
        "description": "```diff\n+ ESCALATION TARGET LOOT UPDATED\n```",
